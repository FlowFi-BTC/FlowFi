...
export const StatBox: React.FC<StatBoxProps> = ({
  ...
  return (
    <div className="rounded-[20px] neo-border-thick bg-white p-5 shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] font-sans">
      ...
      <div className="mt-2 flex items-baseline justify-between">
        ...
        {change && (
          <span
            className={`neo-border rounded-full px-2 py-0.5 text-[10px] font-extrabold ${
