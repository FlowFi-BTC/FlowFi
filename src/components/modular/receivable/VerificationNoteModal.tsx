      ...
      <div className="w-full max-w-2xl rounded-[24px] neo-border-thick bg-white p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-y-auto max-h-[90vh]">
        ...
        <div className="flex items-center justify-between border-b-2 border-black pb-4">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-full bg-[#a8ff3e] neo-border flex items-center justify-center font-syne font-black text-black text-lg">
              ✓
            </div>
            <div>
          ...
          <button
            onClick={onClose}
            className="h-9 w-9 rounded-full neo-border bg-[#f7f7f7] text-black font-extrabold text-lg flex items-center justify-center hover:bg-gray-200"
          >
            ✕
          </button>
        </div>
        ...
        <div className="mt-6 space-y-6">
          ...
          <Card className="bg-[#f7f7f7]">
            ...
            <p className="mt-2 text-sm text-black font-semibold leading-relaxed font-sans">
            ...
            <div className="mt-4 pt-3 border-t-2 border-black flex items-center justify-between text-xs font-syne font-bold text-gray-700">
              ...
              <span className="bg-[#c4b5fd] text-black neo-border px-2 py-0.5 rounded-full">Node #04 Attestation</span>
            </div>
          </Card>
            ...
            <div className="mt-2 space-y-2">
              {note.documents.map((doc, idx) => (
                ...
                >
                  ...
                  <div className="text-[11px] font-bold text-black bg-[#22d3ee] px-2.5 py-1 rounded-full neo-border truncate max-w-[280px]">
                    {doc.hash}
                  </div>
                </div>
              ))}
        ...
        <div className="mt-6 pt-4 border-t-2 border-black flex justify-end">
          <button
            onClick={onClose}
            className="rounded-full neo-border bg-black px-5 py-2 text-xs font-extrabold text-white hover:bg-gray-800 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
          >
            Close Window
          </button>
        </div>
